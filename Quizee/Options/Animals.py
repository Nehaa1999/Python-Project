from tkinter import * #using tkinter module
from random import * #using random module
from tkinter import messagebox #To show a minimalistic Tkinter message box
import time

ANIMALS_WORD = ['DRBI', 'DGO', 'OENDYK', 'GFRIEFA', 'GLOILARTA', 'TAC', 'EHSOR', 'OLIN', 'MYOEKN', 'EEB', 'KDUC',
                'RGFO', 'TPNLEHEA', 'ORCDCIELO', 'POLNIHD', 'LARLIGO', 'EMSUO', 'EGTRI', 'ABRITB', 'ATR', ] #defining jumbled words, it can be changed 

ANIMALS_ANSWER = ['BIRD', 'DOG', 'DONKEY', 'GIRAFFE', 'ALLIGATOR', 'CAT', 'HORSE', 'LION', 'MONKEY', 'BEE', 'DUCK',
                  'FROG', 'ELEPHANT', 'CROCODILE', 'DOLPHIN', 'GORILLA', 'MOUSE', 'TIGER', 'RABBIT', 'RAT', ] #defining correct words for jumbled ones

ran_num = randrange(0, (len(ANIMALS_WORD))) # Using randrange() to generate numbers
...
def main(): #defining main function
    def back():
        my_window.destroy() #destroy() is a universal widget method
        import main_start
    ...
    def cheak():
        ...
        if user_word == ANIMALS_ANSWER[ran_num]:
            ...
            messagebox.showerror("Error", "Inorrect Answer..Try your best!") #message to be displayed in messagebox
            get_input.delete(0, END)
    ...
    my_window = Tk() #tkinter parameters
